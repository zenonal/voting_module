Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :open_id, OpenID::Store::Filesystem.new('/tmp'), :name => 'open_id', :identifier => 'https://www.e-contract.be/eid-idp/endpoints/openid/auth', :domain => 'https://www.e-contract.be/eid-idp-sp/openid/auth-ident.jsp'
